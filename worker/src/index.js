...
const COMPACT_OUTPUT_TOKENS = 900;
...
async function edgeAttempt(env,model,message,history,{instructions,deadline}){
  const timeLeft=deadline?remainingBudget(deadline):EDGE_TIMEOUT_MS;
  if(timeLeft<=0)throw new Error('edge_deadline_exceeded');
